    ...
    <div className="w-full h-screen max-w-[431px] mx-auto bg-white relative">
      <div className="w-full h-full p-5 flex flex-col justify-end gap-10 text-black">
        ...
        <div className="w-full flex items-center justify-between">
          <div className="py-2 px-10 border border-black rounded-[999px] cursor-pointer">Masuk</div>
          <div className="py-2 px-10 border border-black rounded-[999px] bg-black text-white cursor-pointer">Daftar Gratis</div>
        </div>
      </div>
